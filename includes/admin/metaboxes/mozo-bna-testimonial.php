...
<div class="wpmozo_meta_fields">
	<label for="wpmozo_ae_testimonial_author_name">
		<?php esc_html_e( 'Author Name', 'wpmozo-blocks-and-addons' ); ?>
	</label>
...
<div class="wpmozo_meta_fields">
	<label for="wpmozo_ae_testimonial_author_email">
		<?php esc_html_e( 'Author Email', 'wpmozo-blocks-and-addons' ); ?>
	</label>
...
<div class="wpmozo_meta_fields">
	<label for="wpmozo_ae_testimonial_author_designation">
		<?php esc_html_e( 'Author Designation', 'wpmozo-blocks-and-addons' ); ?>
	</label>
...
<div class="wpmozo_meta_fields">
	<label for="wpmozo_ae_testimonial_author_company">
		<?php esc_html_e( 'Author Company', 'wpmozo-blocks-and-addons' ); ?>
	</label>
...
<div class="wpmozo_meta_fields">
	<label for="wpmozo_ae_testimonial_author_company_url">
		<?php esc_html_e( 'Author Company Url', 'wpmozo-blocks-and-addons' ); ?>
	</label>
...
<div class="wpmozo_meta_fields">
	<label for="wpmozo_ae_testimonial_author_rating">
		<?php esc_html_e( 'Author Rating', 'wpmozo-blocks-and-addons' ); ?>
	</label>
