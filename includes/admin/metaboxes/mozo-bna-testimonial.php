...
$author_company_url = get_post_meta( $post->ID, '_author_company_url', true );
$author_rating      = get_post_meta( $post->ID, '_author_rating', true );
$author_rating      = $author_rating ? $author_rating : '5';

wp_nonce_field( 'mozo_metaboxes_nonce', 'mozo_testimonial_metabox_nonce' );
...
<div class="wpmozo_meta_fields">
	...
	<input type="text" id="wpmozo_testimonial_author_name" name="_author_name" value="<?php echo esc_attr( $author_name ); ?>" />
</div>
<div class="wpmozo_meta_fields">
	<label for="wpmozo_testimonial_author_email">
		<?php esc_html_e( 'Author Email', 'divi-plus' ); ?>
	</label>
	<input type="email" id="dipl_testimonial_author_email" name="_author_email" value="<?php echo esc_attr( $author_email ); ?>" />
</div>
<div class="wpmozo_meta_fields">
	<label for="wpmozo_testimonial_author_designation">
		<?php esc_html_e( 'Author Designation', 'divi-plus' ); ?>
	</label>
	<input type="text" id="wpmozo_testimonial_author_designation" name="_author_designation" value="<?php echo esc_attr( $author_designation ); ?>" />
</div>
<div class="wpmozo_meta_fields">
	<label for="wpmozo_testimonial_author_company">
		<?php esc_html_e( 'Author Company', 'divi-plus' ); ?>
	</label>
	<input type="text" id="wpmozo_testimonial_author_company" name="_author_company" value="<?php echo esc_attr( $author_company ); ?>" />
</div>
<div class="wpmozo_meta_fields">
	<label for="wpmozo_testimonial_author_company_url">
		<?php esc_html_e( 'Author Company Url', 'divi-plus' ); ?>
	</label>
	<input type="text" id="wpmozo_testimonial_author_company_url" name="_author_company_url" value="<?php echo esc_attr( $author_company_url ); ?>" />
</div>
<div class="wpmozo_meta_fields">
	<label for="wpmozo_testimonial_author_rating">
		<?php esc_html_e( 'Author Rating', 'divi-plus' ); ?>
	</label>
	<select id="wpmozo_testimonial_author_rating" name="_author_rating">
		<?php
