 ...
 */
class WPMozo_Blocks_And_Addons_Block_Contenttoggle extends WPMozo_Blocks_And_Addons_Block {
	...
	public function __construct() {
		...
		$this->styles[] = array(
			...
			'src'    => WPMOZO_BLOCKS_AND_ADDONS_ASSETS_DIR_URL . 'css/blocks/content-toggle/content-toggle.css',
			'deps'   => array(),
			'ver'    => time(),
		);
