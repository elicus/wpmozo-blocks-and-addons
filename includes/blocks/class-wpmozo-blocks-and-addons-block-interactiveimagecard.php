 ...
 */
class WPMozo_Blocks_And_Addons_Block_Interactiveimagecard extends WPMozo_Blocks_And_Addons_Block {
	...
	public function __construct() {
		...
		$this->styles[] = array(
			...
			'src'    => WPMOZO_BLOCKS_AND_ADDONS_ASSETS_DIR_URL . 'css/blocks/interactive-image-card/interactive-image-card.css',
			'deps'   => array(),
			'ver'    => time(),
		);
