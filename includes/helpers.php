 ...
 */
function wpmozo_ban_get_margin_style( $pre, $props, $use_imp = false ) {
	$imp = $use_imp ? ' !important' : '';
 ...
 */
if ( ! function_exists( 'wpmozo_get_team_member_social' ) ) {
	function wpmozo_get_team_member_social( $type, $url, $icon, $target = true ) {
