...
if ( ! function_exists( 'advanced_button_generate_dynamic_style' ) ) {
	function advanced_button_generate_dynamic_style( $attrs ) {
		...
		return ( ! empty( $styles ) ?
			"<style class='wpmozo-dynamic-style'>{$styles}</style>"
			: '' );
	}
}
