 ...
 * @subpackage WPMozo_Addons_Lite_For_Gutenberg/admin
 */
 ...
 */
class WPMozo_Addons_Lite_Gutenberg_Admin {
	...
	public function enqueue_scripts( $hook_suffix ) {
		...
		wp_register_script(
			...
			WPMOZO_ADDONS_LITE_GUTENBERG_ADMIN_DIR_URL . 'js/admin.js',
			array(
				'jquery',
			),
			WPMOZO_ADDONS_LITE_GUTENBERG_VERSION,
	...
	public function add_meta_boxes( $post_type ) {
		...
		add_meta_box(
	        ...
	        __('Team Member Meta Fields', 'wpmozo-addons-lite-for-gutenberg'),
	...
	public function render_team_member_metabox( $post ) {
		...
		include_once WPMOZO_ADDONS_LITE_GUTENBERG_ADMIN_PARTIALS_DIR_PATH . 'metaboxes/team-member.php';
        ...
        foreach ( $fields as $field ) {
            if ( isset( $_POST[ $field ] ) ) {
                if ( 'wpmozo_team_member_short_desc' === $field ) {
                    ...
                    ${$field} = wpmozo_adfgu_sanitize_text_field( $_POST[ $field ] );
                }
	 ...
	 * @param WPMozo_Addons_Lite_Gutenberg_Admin $instance The instance of this class.
	 */
