...
export default function Edit(props) {
    ...
    const TEMPLATE = [
        [ 'wpmozo/price-list-item', { text: childAttributes.text} ] // Prefills a child block when parent is inserted
    ];
    ...
    const addChildBlock = () => {
        const newBlock = createBlock('wpmozo/price-list-item', { text: childAttributes.text});
