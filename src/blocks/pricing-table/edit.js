                    ...
                    <div className="wpmozo-bna-pricing-table-wrapper">
                        ...
                        <div className="wpmozo-bna-pricing-table-pricing">
                            {'' !== attributes.currencySymbol && 'custom' !== attributes.currencySymbol && (
                                <span
                                    className="wpmozo-bna-pricing-table-currency-symbol">{attributes.currencySymbol} </span>
                            )}
                            {'custom' === attributes.currencySymbol && (
                                <span
                                    className="wpmozo-bna-pricing-table-currency-symbol">{attributes.customSymbol} </span>
                            )}
                            {'' !== attributes.price && (
                                <span className="wpmozo-bna-pricing-table-price">{attributes.price}</span>
                            )}
                            {'' !== attributes.period && (
                                <>
