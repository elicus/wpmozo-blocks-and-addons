...
export const DesignPanel = ( { attributes, setAttributes, hoverState, setHoverState } ) => {
	...
	return ( <>
		...
		<PanelBody title={ __( 'Lens Setting', 'wpmozo-blocks-and-addons' ) } className="wpmozo-typography-panel" initialOpen={true}>
			<RangeControl
		...
		<PanelBody title={ __( 'Sizing', 'wpmozo-blocks-and-addons' ) } className="wpmozo-typography-panel" initialOpen={true}>
			<RangeControl
