...
const V1 = {
    attributes: {
		...
		itemBGImage: { type: "string" },
		itemBGImageSize: { type: "string", default: "cover" },
		itemBGImagePosition: { type: "string", default: "center" },
		itemBGImageRepeat: { type: "string", default: "no-repeat" },
		itemBGImageBlend: { type: "string", default: "normal" },
