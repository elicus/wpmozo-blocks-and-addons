...
const generateDynamicStyle = ( { attributes, isEdit } ) => {
	...
	normalcss.push( 'color' === attributes.scrollEffect && attributes.activeTextColor ? `.wpmozo_scroll_word_color .wpmozo_st_word.visible, .wpmozo_scroll_letter_color .wpmozo_st_letter.visible{ color: ${attributes.activeTextColor} !important; }` : '');
	...
	normalcss.push( 'skew' === attributes.scrollEffect && attributes.skewEffectStart  ? `.wpmozo_scroll_word_skew .wpmozo_st_word, .wpmozo_scroll_letter_slide .wpmozo_st_letter{ skewY( ${attributes.skewEffectStart}deg ); }` : '');
	...
	normalcss.push(
		...
		? `.wpmozo-scroll-text-inner .wpmozo_st_word,
		   .wpmozo-scroll-text-inner .wpmozo_st_letter {
				${attributes.textColor ? `color: ${attributes.textColor} !important;` : ''}
				${convertedStyle.text || ''}
			}`
		: ''
	);
	...
	hovercss.push(
		...
		? `.wpmozo-scroll-text-inner:hover .wpmozo_st_word${isEditor('.wpmozo-scroll-text-inner .wpmozo_st_word')},
		   .wpmozo-scroll-text-inner:hover .wpmozo_st_letter${isEditor('.wpmozo-scroll-text-inner .wpmozo_st_letter')} {
				${attributes.textHoverColor ? `color: ${attributes.textHoverColor} !important;` : ''}
