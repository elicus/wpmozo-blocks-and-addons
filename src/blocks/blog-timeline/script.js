...
jQuery( document ).ready( function($) {
	...
	function wpmozo_bna_timeline_stem($this) {
		...
		var first_icon_offset    = $that.find( '.wpmozo_bna_blog_timeline_post .wpmozo_bna_blog_timeline_stem_center' ).first().offset().top;
		...
		$( window ).on( 'scroll', function() {
			...
			if ( scroll_amount + half_window_height >= widget_bottom ) {
				$this.find( '.wpmozo_bna_blog_stem' ).css( 'height', stem_height_px );
