jQuery(document).ready(function($){
    ...
    let wpmozoInitTilt = function( element ){
        ...
        if ( ! disableMobile || ( disableMobile && ! wpmozoIsMobile() ) ) {
            ...
            $this.find('.wpmozo-bna-tilt-image-inner-wrapper').tilt({
                maxTilt:        maxTilt,
    ...
    jQuery("body").find(".wpmozo-bna-tilt-image").each(function() {
        wpmozoInitTilt( $(this) );
    });
    ...
    jQuery("body").find(".wpmozo-bna-logo-slider-wrap").each(function() {

        let swiperEl = jQuery(this).find('.swiper-container')[0],
        attributes = jQuery(this).data('attr');
        innerWrap = jQuery(swiperEl).closest('.wpmozo-bna-logo-slider-inner-wrap');
    ...
    jQuery(document).find(".wpmozo-bna-team-slider-wrap").each(function( key, el ) {

        let $this = jQuery(this),
            attributes = $this.data('attr'),
            swiperEl = $this.find('.swiper-container')[0],
            innerWrap = jQuery(swiperEl).closest('.wpmozo-bna-swiper-inner-wrap');
