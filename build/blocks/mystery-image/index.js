...
/***/ "./src/blocks/mystery-image/block.json":
/*!*********************************************!*\
  !*** ./src/blocks/mystery-image/block.json ***!
  \*********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wpmozo/mystery-image","version":"0.1.0","title":"Mystery Image","category":"wpmozo","icon":"smiley","description":"Mystery Image block to display random image from selected gallery.","example":{},"supports":{"html":false,"customClassName":false},"attributes":{"ID":{"type":"string"},"className":{"type":"string"},"images_data":{"type":"array","default":[],"source":"query","selector":".wpmozo-blocks-and-addons-gallery--item","query":{"url":{"source":"attribute","selector":"img","attribute":"src"}}},"showLightbox":{"type":"boolean","default":false},"lightboxBackgroundColor":{"type":"string","default":""},"lightboxCloseIconColor":{"type":"string","default":""},"enableOverlay":{"type":"boolean","default":false},"overlayBackgroundColor":{"type":"string"},"overlayIconSize":{"type":"number"},"overlayIconColor":{"type":"string"},"overlayIcon":{"type":"string"}},"textdomain":"wpmozo-blocks-and-addons","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":["wpmozo-blocks-and-addons-magnificPopup-style","file:./style-index.css"],"script":["wpmozo-blocks-and-addons-magnificPopup-script","file:./view.js"]}');

/***/ }),

/***/ "./src/blocks/mystery-image/edit.js":
/*!******************************************!*\
  !*** ./src/blocks/mystery-image/edit.js ***!
  \******************************************/
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/mystery-image/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./inspector */ "./src/blocks/mystery-image/inspector.js");
...
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./style */ "./src/blocks/mystery-image/style.js");
...
const normalizeImages = selectedImages => {
  ...
  return imageArray.map(file => {
    ...
    return (0,_common_components_wpmozo_block_gallery_shared_helpers__WEBPACK_IMPORTED_MODULE_13__.pickRelevantMediaFiles)(file);
  });
};
const createImageCaptionMap = selectedImages => {
  return new Map(selectedImages.map(image => [image.id, image.caption]));
};
const updateImageCaptions = (existingImageBlocks, captionMap) => {
  existingImageBlocks.forEach(block => {
    ...
    if (newCaption !== undefined && block.attributes.caption !== newCaption) {
...
function Edit(props) {
  ...
  const images = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => innerBlockImages?.map(block => ({
  ...
  function updateImages(selectedImages) {
    ...
    if (isFileList(selectedImages) && !normalizedImages.every(isValidFileType)) {
      noticeOperations.removeAllNotices();
      noticeOperations.createErrorNotice((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('All files must be of a valid image format.', 'wpmozo-blocks-and-addons'), {
        id: 'gallery-upload-invalid-file'
      });
      return;
    }
    const newOrderMap = new Map(normalizedImages.map((image, index) => [image.id, index]));
    const existingImageIds = new Set(innerBlockImages.map(block => block.attributes.id));
    const newImageBlocks = normalizedImages.filter(image => !existingImageIds.has(image.id)).map(image => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__.createBlock)('core/image', {
      alt: image.alt,
    ...
    const mergedBlocks = (0,lodash__WEBPACK_IMPORTED_MODULE_1__.concat)(innerBlockImages, newImageBlocks).sort((a, b) => newOrderMap.get(a.attributes.id) - newOrderMap.get(b.attributes.id));
  ...
  const mediaPlaceholder = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.MediaPlaceholder, {
    accept: "image/*",
    ...
    labels: {
      ...
      title: !hasImages && (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Mystery Image', 'wpmozo-blocks-and-addons')
    },
    multiple: true,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.Fragment, {
    children: [isSelected && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.Fragment, {
      ...
      children: [images && Array.isArray(images) && images.length > 0 && (() => {
        const randomIndex = Math.floor(Math.random() * images.length);
        const randomImage = images[randomIndex];
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)("figure", {
          className: "wp-block-image mystery-show",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)("a", {
            href: "#",
            className: "wpmozo-mystery-image-anchor",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)("img", {
              src: randomImage.url,
              alt: randomImage.alt || '',
              className: "wpmozo-mystery-image-img",
              loading: "lazy"
            }), true === attributes.enableOverlay && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.Fragment, {
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)("span", {
                className: "wpmozo-overlay-icon",
      ...
      })(), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_wordpress_primitives__WEBPACK_IMPORTED_MODULE_11__.View, {
...
/***/ "./src/blocks/mystery-image/editor.scss":
/*!**********************************************!*\
  !*** ./src/blocks/mystery-image/editor.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/mystery-image/icon.js":
/*!******************************************!*\
  !*** ./src/blocks/mystery-image/icon.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Icon = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("svg", {
  ...
  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("path", {
    fill: "#000",
    d: "M714.667 10.667h-512c-106.667 0-192 85.333-192 192v512c0 106.667 85.333 192 192 192h313.6c-6.4-12.8-12.8-27.733-19.2-42.667h-294.4c-81.067 0-147.2-66.133-149.333-145.067 55.467-59.733 108.8-119.467 155.733-174.933 27.733-32 46.933-53.333 61.867-51.2 17.067 2.133 32 27.733 46.933 51.2 17.067 29.867 38.4 66.133 72.533 66.133 25.6 0 38.4-17.067 76.8-66.133 6.4-8.533 14.933-19.2 23.467-29.867 36.267-44.8 72.533-93.867 115.2-138.667 21.333-21.333 36.267-34.133 53.333-34.133v0c17.067 0 29.867 10.667 38.4 17.067 38.4 29.867 96 76.8 164.267 132.267v6.4c14.933 6.4 29.867 10.667 42.667 19.2v-313.6c2.133-106.667-83.2-192-189.867-192zM864 435.2c-57.6-46.933-104.533-85.333-138.667-110.933-10.667-8.533-32-25.6-64-25.6v0c-36.267 0-61.867 23.467-85.333 46.933-44.8 46.933-85.333 96-119.467 142.933-8.533 10.667-14.933 19.2-23.467 27.733-10.667 14.933-36.267 46.933-42.667 49.067-10.667 0-25.6-23.467-36.267-44.8-19.2-32-40.533-70.4-78.933-72.533-38.4-4.267-66.133 27.733-98.133 66.133-38.4 44.8-81.067 93.867-123.733 140.8v-452.267c0-83.2 66.133-149.333 149.333-149.333h512c83.2 0 149.333 66.133 149.333 149.333v232.533z"
  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("path", {
    fill: "#000",
    d: "M330.667 354.133c-59.733 0-106.667-46.933-106.667-106.667s46.933-106.667 106.667-106.667 106.667 46.933 106.667 106.667-46.933 106.667-106.667 106.667zM330.667 183.467c-36.267 0-64 27.733-64 64s27.733 64 64 64 64-27.733 64-64-27.733-64-64-64z"
  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("path", {
    fill: "#000",
    d: "M746.667 829.867v-10.667c-2.133-23.467 4.267-49.067 25.6-74.667 19.2-23.467 29.867-38.4 29.867-57.6 0-21.333-12.8-36.267-40.533-36.267-14.933 0-32 4.267-42.667 12.8l-10.667-27.733c14.933-10.667 38.4-17.067 61.867-17.067 49.067 0 70.4 29.867 70.4 61.867 0 29.867-17.067 49.067-36.267 74.667-19.2 21.333-25.6 40.533-23.467 61.867v10.667h-34.133zM738.133 889.6c0-14.933 10.667-27.733 25.6-27.733s25.6 12.8 25.6 27.733c0 14.933-10.667 25.6-25.6 25.6-14.933 2.133-25.6-10.667-25.6-25.6z"
  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("path", {
    fill: "#000",
    d: "M768 1013.333c-134.4 0-245.333-110.933-245.333-245.333s110.933-245.333 245.333-245.333 245.333 110.933 245.333 245.333-110.933 245.333-245.333 245.333zM768 565.333c-110.933 0-202.667 91.733-202.667 202.667s91.733 202.667 202.667 202.667 202.667-91.733 202.667-202.667-91.733-202.667-202.667-202.667z"
  })]
});
...
/***/ "./src/blocks/mystery-image/index.js":
/*!*******************************************!*\
  !*** ./src/blocks/mystery-image/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/mystery-image/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/mystery-image/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/mystery-image/save.js");
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icon */ "./src/blocks/mystery-image/icon.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/mystery-image/style.scss");
...
/***/ "./src/blocks/mystery-image/inspector.js":
/*!***********************************************!*\
  !*** ./src/blocks/mystery-image/inspector.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _settings_generalPanel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./settings/generalPanel */ "./src/blocks/mystery-image/settings/generalPanel.js");
/* harmony import */ var _settings_designPanel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./settings/designPanel */ "./src/blocks/mystery-image/settings/designPanel.js");
...
/***/ "./src/blocks/mystery-image/save.js":
/*!******************************************!*\
  !*** ./src/blocks/mystery-image/save.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ saveWithInnerBlocks)
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style */ "./src/blocks/mystery-image/style.js");
...
function saveWithInnerBlocks({
  ...
  const className = classnames__WEBPACK_IMPORTED_MODULE_0___default()('wpmozo-mystery-image');
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("style", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
        ..._wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
          className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, attributes.className, {
...
/***/ "./src/blocks/mystery-image/settings/designPanel.js":
/*!**********************************************************!*\
  !*** ./src/blocks/mystery-image/settings/designPanel.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const DesignPanel = ({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      ...
      }), true === attributes.enableOverlay && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_common_components__WEBPACK_IMPORTED_MODULE_2__.WpmozoColorPicker, {
          ...
          step: 1,
          max: 500
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_common_components__WEBPACK_IMPORTED_MODULE_2__.WpmozoColorPicker, {
          ColorKey: "overlay",
          props: props,
          ColorTypes: [{
            key: 'IconColor',
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_common_components__WEBPACK_IMPORTED_MODULE_2__.WpmozoIconpicker, {
          props: props,
    ...
    }), true === attributes.showLightbox && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_common_components__WEBPACK_IMPORTED_MODULE_2__.WpmozoColorPicker, {
        ...
        ColorTypes: [{
          key: 'BackgroundColor',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Lightbox Background Color', 'wpmozo-blocks-and-addons')
        }, {
          key: 'CloseIconColor',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Close Icon Color', 'wpmozo-blocks-and-addons')
        }]
      })
    })]
  });
...
/***/ "./src/blocks/mystery-image/settings/generalPanel.js":
/*!***********************************************************!*\
  !*** ./src/blocks/mystery-image/settings/generalPanel.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/mystery-image/style.js":
/*!*******************************************!*\
  !*** ./src/blocks/mystery-image/style.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/mystery-image/style.scss":
/*!*********************************************!*\
  !*** ./src/blocks/mystery-image/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"blocks/mystery-image/index": 0,
/******/ 			"blocks/bar-counter/style-index": 0,
/******/ 			"blocks/mystery-image/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/bar-counter/style-index","blocks/mystery-image/style-index"], () => (__webpack_require__("./src/blocks/mystery-image/index.js")))
